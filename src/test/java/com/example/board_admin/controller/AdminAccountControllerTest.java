...
import com.example.board_admin.service.AdminAccountService;
...
class AdminAccountControllerTest {
    ...
    @Test
    void givenAuthorized_whenRequestingAdminMembersView_thenReturnsAdminMembersView() throws Exception {
        //given
    ...
    @Test
    void givenAuthorized_whenRequestingAdminMembers_thenReturnsAdminMembers() throws Exception {
        //given
    ...
    void givenAuthorized_whenDeletingAdminMember_thenDeletesAdminMember() throws Exception {
        ...
        //when && then
        mvc.perform(delete("/api/admin/members/" + username)
                        .with(csrf())
                )
